...
var arr = [10,20,30];
//Create a function named 'first' that is given 'arr' as the argument and  returns the first  in the given array.
...
const reversedLooper = letters => letters.slice(0).reverse().map(letter => alert(letter));
...
If it is, return true, if it's not, return false */
  ...
  function finder(numbers) {
    let present = false;
    if (numbers.includes(getRandomArbitrary())) {
        present = true;
    }
    return present;
}
...
*/
  ...
  // const removeItem = (myGroceryList, item) => {
    // myGroceryList.filter(function(val) => val === item ? myGroceryList(splice(i, 1)))
  // }
...
var user2 = {
  name: 'AJ Styles',
  email: 'phenomenalone@gmail.com',
  password: 'c@lfcru$3r',
  username: 'TheMan'
};

var user3 = {
  name: 'Shisuke Nakamura',
  email: 'shisuke@gmail.com',
  password: 'str0ngstyl3',
  username: 'KingOfStrongStyle'
};
